...
export function SearchTarget({ targetList, text, onChangeText, onSubmitText }: IBTargetListProps) {
  ...
  return (
    ...
    <S.FlatListContainer
    data={targetList}
    renderItem={({item}) =><TargetCity item={item} onPress={onPress} selectedId={selectedId}/>}
